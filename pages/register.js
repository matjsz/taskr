...
export default function Landing() {
    ...
    useEffect(() => {
        // Registra um novo usuário com os dados capturados nos parâmetros de URL
        onAuthStateChanged(auth, (user) => {
            if(user){
                Router.push('/')
            } else{
                registerUser(query.e, query.p, query.n)
                    .then((userCredential) => {
	...
	return (
		<div>
            ...
            <div className='flex justify-center mt-28 text-xl'>
                <Loading/>
                <p className=''><strong>Criando sua conta...</strong></p>
            </div>
